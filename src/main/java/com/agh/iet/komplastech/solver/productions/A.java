...
//            }
        	...
        	for (int k=1; k<=gauss.m_nr_points; k++) {
           	  double x = gauss.m_points[k]*T.m_mesh.getElementsX()/T.m_mesh.getElementsX() + T.m_beg; //+ beginning of actual element;
          	  for (int l=1; l<=gauss.m_nr_points; l++) {
          	  	if(i>2) {
           	      double y = (gauss.m_points[l]+(i-3))*T.m_mesh.getResolutionY()/T.m_mesh.getElementsY();
                  ...
                  double y = (gauss.m_points[l]+(i-2))*T.m_mesh.getResolutionY()/T.m_mesh.getElementsY();
                ...
                if((i-1)<T.m_mesh.getElementsY()) {
                  double y = (gauss.m_points[l]+(i-1))*T.m_mesh.getResolutionY()/T.m_mesh.getElementsY();
        	...
        	for (int k=1; k<=gauss.m_nr_points; k++) {
           	  double x = gauss.m_points[k]*T.m_mesh.getResolutionX()/T.m_mesh.getElementsX() +  T.m_beg; //+ beginning of actual element;
          	  for (int l=1; l<=gauss.m_nr_points; l++) {
          	  	if(i>2) {
	           	  double y = (gauss.m_points[l]+(i-3))*T.m_mesh.getResolutionY()/T.m_mesh.getElementsY();
