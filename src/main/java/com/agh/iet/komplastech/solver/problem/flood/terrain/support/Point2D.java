package com.agh.iet.komplastech.solver.problem.flood.terrain.support;

import java.util.Comparator;


public final class Point2D<T> implements Comparable<Point2D> {
     ...
     */
    public Point2D(double x, double y, T data) {
